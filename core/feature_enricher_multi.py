...
from core.feature_enricher import enrich_features

def enrich_multi_interval_features(stock: str, sim_date: datetime, intervals: list = ["day", "60m", "15m"]) -> pd.DataFrame:
    dfs = []
